...
def main() -> None:
    ...
    for arg in sys.argv[1:]:
        ...
        # Ensure we have both a name and a quantity before updating
        if key and val:
    ...
    # Sorting (Bubble sort implementation due to constraints)
    # Using list comprehension to convert dict items to list of tuples
