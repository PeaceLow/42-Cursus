...
def ft_score_analytics(args) -> None:
    """
    Analyse les scores des joueurs fournis en arguments
    ...
    print(f"High score: {highest_score:.0f}")
    print(f"Low score: {lowest_score:.0f}")
    print(f"Score range: {highest_score - lowest_score:.0f}\n")
